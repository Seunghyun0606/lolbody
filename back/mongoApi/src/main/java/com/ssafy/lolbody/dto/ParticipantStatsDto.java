...
public class ParticipantStatsDto {
	...
	public String toString() {
		return "ParticipantStatsDto [item0=" + item0 + ", item2=" + item2 + ", totalUnitsHealed=" + totalUnitsHealed
				...
				+ ", damageSelfMitigated=" + damageSelfMitigated + ", largestCriticalStrike=" + largestCriticalStrike
				+ ", nodeNeutralize=" + nodeNeutralize + ", totalTimeCrowdControlDealt=" + totalTimeCrowdControlDealt
				+ ", firstTowerKill=" + firstTowerKill + ", magicDamageDealt=" + magicDamageDealt + ", totalScoreRank="
				+ totalScoreRank + ", nodeCapture=" + nodeCapture + ", wardsPlaced=" + wardsPlaced
				+ ", totalDamageDealt=" + totalDamageDealt + ", timeCCingOthers=" + timeCCingOthers
				+ ", magicalDamageTaken=" + magicalDamageTaken + ", largestKillingSpree=" + largestKillingSpree
				+ ", totalDamageDealtToChampions=" + totalDamageDealtToChampions + ", physicalDamageDealtToChampions="
				+ physicalDamageDealtToChampions + ", neutralMinionsKilledTeamJungle=" + neutralMinionsKilledTeamJungle
				+ ", totalMinionsKilled=" + totalMinionsKilled + ", firstInhibitorAssist=" + firstInhibitorAssist
				...
				+ ", combatPlayerScore=" + combatPlayerScore + ", inhibitorKills=" + inhibitorKills + ", turretKills="
				+ turretKills + ", participantId=" + participantId + ", trueDamageTaken=" + trueDamageTaken
				+ ", firstBloodAssist=" + firstBloodAssist + ", nodeCaptureAssist=" + nodeCaptureAssist + ", assists="
				+ assists + ", teamObjective=" + teamObjective + ", altarsNeutralized=" + altarsNeutralized
				+ ", goldSpent=" + goldSpent + ", damageDealtToTurrets=" + damageDealtToTurrets + ", altarsCaptured="
				+ altarsCaptured + ", win=" + win + ", totalHeal=" + totalHeal + ", unrealKills=" + unrealKills
				+ ", visionScore=" + visionScore + ", physicalDamageDealt=" + physicalDamageDealt + ", firstBloodKill="
				+ firstBloodKill + ", longestTimeSpentLiving=" + longestTimeSpentLiving + ", killingSprees="
				+ killingSprees + ", sightWardsBoughtInGame=" + sightWardsBoughtInGame + ", trueDamageDealtToChampions="
				+ trueDamageDealtToChampions + ", neutralMinionsKilledEnemyJungle=" + neutralMinionsKilledEnemyJungle
				+ ", doubleKills=" + doubleKills + ", trueDamageDealt=" + trueDamageDealt + ", quadraKills="
				+ quadraKills + ", item4=" + item4 + ", item3=" + item3 + ", item6=" + item6 + ", item5=" + item5
				+ ", playerScore0=" + playerScore0 + ", playerScore1=" + playerScore1 + ", playerScore2=" + playerScore2
				+ ", playerScore3=" + playerScore3 + ", playerScore4=" + playerScore4 + ", playerScore5=" + playerScore5
				+ ", playerScore6=" + playerScore6 + ", playerScore7=" + playerScore7 + ", playerScore8=" + playerScore8
				+ ", playerScore9=" + playerScore9 + ", perk0=" + perk0 + ", perk0Var1=" + perk0Var1 + ", perk0Var2="
				+ perk0Var2 + ", perk0Var3=" + perk0Var3 + ", perk1=" + perk1 + ", perk1Var1=" + perk1Var1
				+ ", perk1Var2=" + perk1Var2 + ", perk1Var3=" + perk1Var3 + ", perk2=" + perk2 + ", perk2Var1="
				+ perk2Var1 + ", perk2Var2=" + perk2Var2 + ", perk2Var3=" + perk2Var3 + ", perk3=" + perk3
				+ ", perk3Var1=" + perk3Var1 + ", perk3Var2=" + perk3Var2 + ", perk3Var3=" + perk3Var3 + ", perk4="
				+ perk4 + ", perk4Var1=" + perk4Var1 + ", perk4Var2=" + perk4Var2 + ", perk4Var3=" + perk4Var3
				+ ", perk5=" + perk5 + ", perk5Var1=" + perk5Var1 + ", perk5Var2=" + perk5Var2 + ", perk5Var3="
				+ perk5Var3 + ", perkPrimaryStyle=" + perkPrimaryStyle + ", perkSubStyle=" + perkSubStyle + "]";
	}
}